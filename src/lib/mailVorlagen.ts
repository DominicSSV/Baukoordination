...
export const STANDARD_VORLAGEN: Vorlage[] = [
  {
    ...
    text: [
      ...
      '',
      'Tipp: Setz dir gleich beim ersten Mal ein Passwort (oben rechts auf dein Bild, dann "Passwort für die Anmeldung").',
      'Danach meldest du dich mit deiner E-Mail-Adresse an, und dein Handy merkt sich die Anmeldung – den Code brauchst du dann nicht mehr zu suchen.',
      '',
