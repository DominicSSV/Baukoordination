...
export const STANDARD_VORLAGEN: Vorlage[] = [
  {
    ...
    beschreibung:
      'Geht raus, wenn du bei einem Lieferanten auf „Einladen“ drückst. Enthält den Zugangscode.',
    ...
    text: [
      ...
      '',
      'Du kannst dich auch mit deiner E-Mail-Adresse und dem Passwort anmelden, das wir dir mitgeteilt haben – dein Handy merkt sich die Anmeldung dann, und du musst den Code nicht jedes Mal suchen.',
      'Das Passwort gilt nur für diese App. Brauchst du ein neues, melde dich bei uns.',
      '',
    ...
    platzhalter: [
      ...
      { name: '{code}', erklaerung: 'Persönlicher Zugangscode' },
